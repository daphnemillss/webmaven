...
public class Mensagens extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>"); 
            out.println("<title>Olá Mundo</title>");
            out.println("<link href=\"css/bootstrap.min.css\" rel=\"stylesheet\">");
            out.println("<link href=\"css/style.css\" rel=\"stylesheet\">");
            out.println("<meta http-equiv=\"refresh\" content=\"5\"");            
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>"+request.getParameter("from")+request.getParameter("to")+"</h1>");
            ...
            try {
                ...
                if (rs != null) {
                    while (rs.next()) {
                        out.println("<p>["+rs.getTimestamp("data")+"] "+rs.getString("remetente")+" diz:\n" +rs.getString("texto")+"</p>");
                    }
                }
